"""
Django settings for Peerlogic VoIP Admin.
"""
...
# Database
# Use DATABASE_URL if set (production), otherwise SQLite (local dev)
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Peerlogic VoIP Admin API',
    'DESCRIPTION': 'Universal VoIP administration API for managing phone systems across multiple providers.',
    'VERSION': '1.0.0',
